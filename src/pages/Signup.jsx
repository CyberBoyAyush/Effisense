...
const Signup = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#0A0A0A] bg-gradient-to-br from-black via-gray-900 to-[#0F0F0F] py-12 px-4 sm:px-6 lg:px-8 overflow-hidden relative">
      ...
      <motion.div 
        className="max-w-md w-full space-y-6 bg-gray-800/50 backdrop-blur-sm p-6 sm:p-8 rounded-2xl border border-orange-700/30
        shadow-lg z-10"
      ...
      >
        ...
        <div className="text-center">
          ...
          >
            Join Effisense and boost your productivity
          </motion.p>
        </div>
